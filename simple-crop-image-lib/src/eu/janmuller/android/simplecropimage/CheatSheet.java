 ...
 * long-press. This is already default platform behavior for icon-only
...
public class CheatSheet {
	 ...
	 * This is used to determine whether or not the toast should appear above or
	 * below the UI element.
	 */
